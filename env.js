 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.three.thousand
 */
const BUNDLE_ID = "com.three.thousand"; // ios bundle id
const PACKAGE = "com.three.thousand"; // android package name
const NAME = "Thousand"; // app name
const SCHEME = "thousand"; // app scheme
...
const withEnvSuffix = (name) => {
  return APP_ENV === "production" ? name : `${name}.dev`;
};

const withAppNameSuffix = (name) => {
  return APP_ENV === "production" ? name : `${name}Dev`;
};
/**
...
const client = z.object({
  ...
  PACKAGE: z.string(),
  VERSION: z.string(),
  IOS_BUILD_NUMBER: z.string(),
  ANDROID_BUILD_NUMBER: z.number(),
});

const buildTime = z.object({
  // AndroidKeyStore
  // MYAPP_RELEASE_STORE_FILE: z.string(),
  // MYAPP_RELEASE_KEY_ALIAS: z.string(),
  // MYAPP_RELEASE_STORE_PASSWORD: z.string(),
  // MYAPP_RELEASE_KEY_PASSWORD: z.string()
});
...
const _clientEnv = {
  APP_ENV,
  NAME: withAppNameSuffix(NAME),
  SCHEME: SCHEME,
  BUNDLE_ID: withEnvSuffix(BUNDLE_ID),
  PACKAGE: withEnvSuffix(PACKAGE),
  VERSION: packageJSON.version,
  IOS_BUILD_NUMBER: packageJSON["ios-build-number"],
  ANDROID_BUILD_NUMBER: packageJSON["android-build-number"],
 ...
 */
const _buildTimeEnv = {
  // MYAPP_RELEASE_STORE_FILE: process.env.MYAPP_RELEASE_STORE_FILE,
  // MYAPP_RELEASE_KEY_ALIAS: process.env.MYAPP_RELEASE_KEY_ALIAS,
  // MYAPP_RELEASE_STORE_PASSWORD: process.env.MYAPP_RELEASE_STORE_PASSWORD,
  // MYAPP_RELEASE_KEY_PASSWORD: process.env.MYAPP_RELEASE_KEY_PASSWORD
};
